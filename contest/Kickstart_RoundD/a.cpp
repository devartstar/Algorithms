...
void solve() {
    ...
    f0(i, n) {
        ...
        if(visited1[v[i].ff] == false && visited1[v[i].ss] == false) {
            cnt1++;
            visited1[v[i].ff] = visited1[v[i].ss] = true;
        } else if (visited2[v[i].ff] == false && visited2[v[i].ss] == false) {
            cnt2++;
            visited2[v[i].ff] = visited2[v[i].ss] = true;
        } else {
            cout << "NO" << endl;
            return;
        }
